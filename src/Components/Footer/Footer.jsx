        ...
        <footer className={style.footer}>
            <div className={`${style.footerContent} ${style.container}`}>
                <div className={`${style.footerSocial} ${style.social}`}>
                    ...
                    <a href="https://www.linkedin.com/in/nick-kholod-575719252/" className={style.socialItem}><img src="https://papil10n.github.io/Web_blog/img/ico%20svg/Linkedin.svg" alt="Linkedin" /></a>
